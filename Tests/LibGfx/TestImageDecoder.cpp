...
TEST_CASE(test_jbig2_decode)
{
    ...
    Array test_inputs = {
        ...
        TEST_INPUT("jbig2/bitmap-exttemplate.jbig2"sv),
        TEST_INPUT("jbig2/bitmap-exttemplate-customat.jbig2"sv),
        TEST_INPUT("jbig2/bitmap-exttemplate-customat-tpgdon.jbig2"sv),
