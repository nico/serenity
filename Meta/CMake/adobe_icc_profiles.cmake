...
if (ENABLE_ADOBE_ICC_PROFILES_DOWNLOAD)
    ...
    set(ADOBE_ICC_PROFILES_INSTALL_PATH "${CMAKE_CURRENT_BINARY_DIR}/Adobe")
    ...
    if (SERENITYOS)
        install(DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/Adobe/" DESTINATION "${CMAKE_BINARY_DIR}/Root/res/icc")
    endif()
endif()
