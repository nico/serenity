...
void draw_gouraud_triangle(Gfx::Painter& painter, NonnullRefPtr<ColorSpace> color_space, GouraudFunctionsType functions, Array<Gfx::FloatPoint, 3> points, Array<GouraudColor, 3> colors)
{
    ...
    // To hide triangle edges. (Setting this to true is useful for debugging.)
    bool const anti_alias = false;
    painter.fill_path(triangle_path, paint_style, 1.0f, Gfx::WindingRule::Nonzero, anti_alias);
}
